...
ATrapdoor::ATrapdoor() {
	...
	LeftHinge = CreateDefaultSubobject<UPhysicsConstraintComponent>(TEXT("Right Hinge"));
	RightHinge = CreateDefaultSubobject<UPhysicsConstraintComponent>(TEXT("Left Hinge"));
